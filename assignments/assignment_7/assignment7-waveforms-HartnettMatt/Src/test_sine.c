...
// For some baffling reason, I can't get a float to print. I type casted all of the printing
// values to integers (except for the sine error, I mulitplied by 100 then casted to preserve some
// accuracy in the value).
...
void test_sin()
{
  ...
  printf("sin(x) max_err=%d  sum_sq=%d\r\n", (int)(max_err*100), (int)sum_sq);
...
void test_sqrt_sin()
{
    ...
    printf("sqrt(sin(x)) max_err=%d  sum_sq=%d\r\n", (int)max_err, (int)sum_sq);
