 ...
 *
 * Returns:
 *   The dequeued element, or NULL if the FIFO was empty or for any error such as fifo being NULL.
 */
void *llfifo_dequeue(llfifo_t *fifo);

/*
 * Peeks(views) an element that will be available for next dequeue from the FIFO, and returns it
 * Does not dequeue(remove) element from the queue.
 *
 * Parameters:
 *   fifo  The fifo in question
 *
 * Returns:
 *   The peeked lement that will be availalbe for next dequeue, or NULL if the FIFO was empty or
 *   FIFO is NULL.
 */
 ...
 *
 * Returns:
 *   The number of elements currently on the FIFO or -1 for any errors such as FIFO being NULL.
 */
 ...
 *
 * Returns:
 *   The current capacity, in number of elements, for the FIFO or -1 for any error such as FIFO being NULL.
 */
 ...
 *
 * Returns:
 *   The max capacity, in number of elements, for the FIFO or -1 for any errors such as FIFO being NULL.
 */
